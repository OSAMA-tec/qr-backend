...
const { campaignValidation, campaignFormValidation } = require('../middleware/validation.middleware');
...
router.post('/submit', csrfProtection, campaignFormValidation, submitCampaignForm);  // Submit campaign form
